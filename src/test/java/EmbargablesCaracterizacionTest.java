...
public class EmbargablesCaracterizacionTest {
    ...
    public void testCargarCaracterizacionesDesdeDirectorios() throws IOException {
        ...
        Map<String, Caracterizacion> EmbargadoCaracterizaciones = superCache.getEmbargablesCharacterizations();
        assertFalse(EmbargadoCaracterizaciones.isEmpty(), "La caché de Embargados no debe estar vacía después de cargar los datos.");

        // Imprimir el contenido de la caché de inhabilitados
        System.out.println("Contenido de la caché de Embargados:");
        for (Caracterizacion caracterizacion : EmbargadoCaracterizaciones.values()) {
